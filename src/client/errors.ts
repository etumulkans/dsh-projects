...
const ERROR_TRANSLATION_KEYS = {
  ...
  'approval.notStarted': 'error.approvalNotStarted',
  'approval.runUnknown': 'error.approvalRunUnknown',
  'approval.invalidStatus': 'error.approvalInvalidStatus',
  'approval.staleVersion': 'error.approvalStaleVersion',
  'approval.unknown': 'error.approvalUnknown',
  'artifact.notStarted': 'error.artifactNotStarted',
  'artifact.unknown': 'error.artifactUnknown',
  'artifact.runUnknown': 'error.artifactRunUnknown',
  'artifact.badRequest': 'error.artifactBadRequest',
  'artifact.invalidCandidate': 'error.artifactInvalidCandidate',
  'artifact.contentTooLarge': 'error.artifactContentTooLarge',
  'artifact.missingUrl': 'error.artifactMissingUrl',
  'artifact.kindReserved': 'error.artifactKindReserved',
  'artifact.containsSecrets': 'error.artifactContainsSecrets',
  'artifact.reportFailed': 'error.artifactReportFailed',
  'trigger.notStarted': 'error.triggerNotStarted',
  'trigger.unknown': 'error.triggerUnknown',
  'trigger.badRequest': 'error.triggerBadRequest',
  'trigger.invalidCandidate': 'error.triggerInvalidCandidate',
  'trigger.manualReserved': 'error.triggerManualReserved',
  'trigger.containsSecrets': 'error.triggerContainsSecrets',
  'trigger.disabled': 'error.triggerDisabled',
  'trigger.goalEmpty': 'error.triggerGoalEmpty',
  'trigger.goalTooLong': 'error.triggerGoalTooLong',
  ...
  'memory.invalidCandidate': 'error.memoryInvalidCandidate',
  'memory.immutable': 'error.memoryImmutable',
  'memory.invalidStatus': 'error.memoryInvalidStatus',
  'memory.notStarted': 'error.memoryNotStarted',
  'memory.projectNotFound': 'error.memoryProjectNotFound',
  'memory.staleVersion': 'error.memoryStaleVersion',
  'memory.unknown': 'error.memoryUnknown',
  ...
  'plan.replanBudgetExceeded': 'error.planReplanBudgetExceeded',
  ...
  'run.budgetInvalid': 'error.runBudgetInvalid',
  'run.budgetPhaseInvalid': 'error.runBudgetPhaseInvalid',
  ...
  'task.retryBudgetExceeded': 'error.taskRetryBudgetExceeded',
  ...
  'task.commitFailed': 'error.taskCommitFailed',
  'task.workspaceConflict': 'error.taskWorkspaceConflict',
  'task.worktreeFailed': 'error.taskWorktreeFailed',
