...
```powershell
dsh plugin --profile web add dsh-dashboard@0.12.0
dsh web --dump-config
dsh web
```
...
```powershell
npx --yes @deepseek-ai/dsh@0.1.0-rc.6 plugin --profile web add dsh-dashboard@0.12.0
...
pnpm pack
dsh plugin --profile web add ./dsh-dashboard-0.12.0.tgz
dsh web
```
